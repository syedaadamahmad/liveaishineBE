...
class LangChainRAGEngine:
    ...
    def __init__(self):
        ...
        try:
            ...
            # Summary is triggered when context exceeds 1000 tokens.
...
Standalone question:"""
        ...
        qa_template = """You are AI Shine, an expert educational assistant specializing in Artificial Intelligence, Machine Learning, and related technologies.
...
1. SCOPE: Only answer topics in AI, ML, Deep Learning, Data Science, NLP, Computer Vision, AI Applications, AI Education, Programming for AI/ML.
2. HALLUCINATION GUARDRAIL: 
   - If KB mentions a concept but doesn't define it (e.g., "machine learning" in examples):
     [1] Lead with clear definition using your AI/ML training knowledge
     [2] Then integrate KB examples naturally (e.g., "It's used in Netflix recommendations...")
     [3] Do NOT start with "The provided content doesn't define..."
   - NEVER invent specific examples, tools, statistics, or applications not in KB
   - Only provide general conceptual definitions when needed
3. FORMATTING:
   - Use <p> for paragraphs with blank line between each
   - Use <ul><li> for lists with blank line between each <li>
   - Use <strong> for key terms (2-4 words)
   - ALL content must be wrapped in HTML tags
   - If response is long, end with: <p><em>Write 'continue' to keep generating...</em></p>
4. OUT OF SCOPE: If topic is not AI/ML related, respond:
